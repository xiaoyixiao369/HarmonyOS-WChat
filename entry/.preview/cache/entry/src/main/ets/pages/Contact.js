...
export class Contact extends ViewPU {
    ...
    buildItem(image, title, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Row.create();
            Row.debugLine("pages/Contact.ets(110:5)");
            Row.width('96%');
            Row.height(50);
            if (!isInitialRender) {
                Row.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Image.create(image);
            Image.debugLine("pages/Contact.ets(111:7)");
            Image.width(40);
            Image.height(40);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(title);
            Text.debugLine("pages/Contact.ets(118:7)");
            Text.fontWeight(500);
            Text.margin({
                left: 10
            });
    ...
    buildListItemHeader(index, parent = null) {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/Contact.ets(129:5)");
            Row.width('104%');
            Row.height(40);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create(index);
            Text.debugLine("pages/Contact.ets(130:7)");
            Text.fontWeight(700);
            Text.margin({ left: 10 });
            if (!isInitialRender) {
                Text.pop();
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/Contact.ets(142:5)");
            Row.height('100%');
            if (!isInitialRender) {
                Row.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("pages/Contact.ets(143:7)");
            Stack.width('100%');
            Stack.height('100%');
            if (!isInitialRender) {
                Stack.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/Contact.ets(144:9)");
            Column.width('100%');
            if (!isInitialRender) {
                Column.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/Contact.ets(146:11)");
            List.width('100%');
            List.divider({
                strokeWidth: 2,
                startMargin: 50
        ...
        });
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ...
                ListItem.debugLine("pages/Contact.ets(147:13)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                this.observeComponentCreation(itemCreation);
                this.buildItem.bind(this)({ "id": 16777237, "type": 20000, params: [], "bundleName": "com.example.wechat", "moduleName": "entry" }, '新的朋友');
                ListItem.pop();
            };
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Contact.ets(151:13)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                this.observeComponentCreation(itemCreation);
                this.buildItem.bind(this)({ "id": 16777227, "type": 20000, params: [], "bundleName": "com.example.wechat", "moduleName": "entry" }, '群聊');
                ListItem.pop();
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Contact.ets(155:13)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                this.observeComponentCreation(itemCreation);
                this.buildItem.bind(this)({ "id": 16777253, "type": 20000, params: [], "bundleName": "com.example.wechat", "moduleName": "entry" }, '标签');
                ListItem.pop();
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
        ...
        }
        {
            ...
            const itemCreation = (elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                ListItem.create(deepRenderFunction, isLazyCreate);
                ListItem.debugLine("pages/Contact.ets(159:13)");
                if (!isInitialRender) {
                    ListItem.pop();
                }
                ViewStackProcessor.StopGetAccessRecording();
            ...
            const observedDeepRender = () => {
                this.observeComponentCreation(itemCreation);
                this.buildItem.bind(this)({ "id": 16777240, "type": 20000, params: [], "bundleName": "com.example.wechat", "moduleName": "entry" }, '公众号');
                ListItem.pop();
            };
            const deepRenderFunction = (elmtId, isInitialRender) => {
                itemCreation(elmtId, isInitialRender);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            List.debugLine("pages/Contact.ets(168:11)");
            List.width('100%');
            List.height(400);
            List.divider({
                strokeWidth: 2,
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation((elmtId, isInitialRender) => {
                    ...
                    ListItemGroup.debugLine("pages/Contact.ets(170:15)");
                    if (!isInitialRender) {
                        ListItemGroup.pop();
                    }
                    ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            AlphabetIndexer.debugLine("pages/Contact.ets(186:9)");
